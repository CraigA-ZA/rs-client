package org.runestar.client.updater.mapper.identifiers
...
abstract class ByteArrayPoolArray(index: Int) : OrderMapper.InClassInitializer.Field(ByteArrayPool::class, index) {
    override val predicate = predicateOf<Instruction2> { it.opcode == PUTSTATIC && it.fieldType == Type.BYTE_TYPE.withDimensions(2) }
}
