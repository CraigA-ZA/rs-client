...
public final class WorldMapManager {
   ...
   public void load(AbstractArchive var1, String var2, boolean var3) {
      if (!this.loadStarted) {
         ...
         this.ao = this.mapAreaData.minX() * -1335619264;
         this.ax = this.mapAreaData.minY() * 683814720;
         this.ai = (this.mapAreaData.maxX() - this.mapAreaData.minX() + 1) * -1863614400;
         this.ag = (this.mapAreaData.maxY() - this.mapAreaData.minY() + 1) * -935980224;
         int var9 = this.mapAreaData.maxX() - this.mapAreaData.minX() + 1;
         int var10 = this.mapAreaData.maxY() - this.mapAreaData.minY() + 1;
         System.nanoTime();
         System.nanoTime();
         Friend.aw_renamed();
   ...
   ju aq(int var1, int var2, int var3, int var4) {
      ...
      var6.aw = (var11 - this.mapAreaData.minX()) * 507320219;
      var6.ac = (var12 - this.mapAreaData.minY()) * -1727465605;
