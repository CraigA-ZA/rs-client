public final class Sprite extends Rasterizer2D {
   ...
   public Sprite aw() {
      ...
      for(int var2 = 0; var2 < this.subHeight; ++var2) {
         for(int var3 = 0; var3 < this.subWidth; ++var3) {
            var1.pixels[(var2 + this.xOffset) * this.width + var3 + this.yOffset] = this.pixels[var2 * this.subWidth + var3];
         }
      }
   ...
   public void ac() {
      Rasterizer2D_replace(this.pixels, this.subWidth, this.subHeight, (float[])null);
   }
   ...
   public void normalize() {
      if (this.subWidth != this.width || this.subHeight != this.height) {
         ...
         for(int var2 = 0; var2 < this.subHeight; ++var2) {
            for(int var3 = 0; var3 < this.subWidth; ++var3) {
               var1[(var2 + this.xOffset) * this.width + var3 + this.yOffset] = this.pixels[var2 * this.subWidth + var3];
            }
         }
   ...
   public void ay(int var1, int var2) {
      ...
      if (var6 > 0 && var5 > 0) {
         ao_renamed(Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void ax(int var1, int var2) {
      ...
      if (var6 > 0 && var5 > 0) {
         ai_renamed(Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void ag(int var1, int var2, int var3, int var4) {
      if (var3 > 0 && var4 > 0) {
         ...
         int var13;
         if (this.yOffset > 0) {
            var13 = ((this.yOffset << 16) + var11 - 1) / var11;
            var1 += var13;
            var7 += var13 * var11 - (this.yOffset << 16);
         }

         if (this.xOffset > 0) {
            var13 = ((this.xOffset << 16) + var12 - 1) / var12;
            var2 += var13;
         ...
         ah_renamed(Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }
   ...
   public void av(int var1, int var2, int var3, int var4) {
      if (var3 == 256) {
         ...
         if (var8 > 0 && var7 > 0) {
            ar_renamed(Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
         }
      }
   }
   ...
   public void am(int var1, int var2, int var3) {
      ...
      if (var7 > 0 && var6 > 0) {
         as_renamed(Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }
   ...
   public void aj(int var1, int var2, int var3, int var4, int var5) {
      if (var3 > 0 && var4 > 0) {
         ...
         int var14;
         if (this.yOffset > 0) {
            var14 = ((this.yOffset << 16) + var12 - 1) / var12;
            var1 += var14;
            var8 += var14 * var12 - (this.yOffset << 16);
         }

         if (this.xOffset > 0) {
            var14 = ((this.xOffset << 16) + var13 - 1) / var13;
            var2 += var14;
         ...
         ak_renamed(Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }
   ...
   public void az(int var1, int var2, int var3) {
      ...
      if (var7 > 0 && var6 > 0) {
         if (var3 == 256) {
            ad_renamed(0, 0, 0, Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
         } else {
            ae_renamed(0, 0, 0, Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
         }
   ...
   public void ap(int var1, int var2, int var3, int var4, int var5) {
      if (var3 > 0 && var4 > 0) {
         ...
         if (var5 == 256) {
            by_renamed(0, 0, 0, var8, this.pixels, Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
         } else {
            bb_renamed(0, 0, 0, var8, this.pixels, Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
         }
      ...
      try {
         ...
         for(var2 = 0; var2 < var4; ++var2) {
            ...
            for(var1 = -var10[var2]; var1 < 0; ++var1) {
               Rasterizer2D_pixels[var19++] = this.pixels[(var20 >> 16) + (var21 >> 16) * this.subWidth];
               var20 += var14;
               var21 -= var13;
            }
   ...
   public void bx(int var1, int var2, int var3, int var4) {
      this.bo(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
   }
               ...
               if (var27 == 0) {
                  if (var26 == 0) {
                     for(var33 = var22; var33 < 0; var23 += Rasterizer2D_width) {
                        ...
                        if (var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0 && var31 - (this.subHeight << 12) < 0) {
                           for(; var37 < 0; ++var37) {
                              var38 = this.pixels[(var36 >> 12) * this.subWidth + (var35 >> 12)];
                              if (var38 != 0) {
                     ...
                     for(var33 = var22; var33 < 0; var23 += Rasterizer2D_width) {
                        ...
                        if (var30 >= 0 && var30 - (this.subWidth << 12) < 0) {
                           ...
                           if ((var32 = (1 + var36 - (this.subHeight << 12) - var26) / var26) > var37) {
                              var37 = var32;
                           }
                  ...
                  for(var33 = var22; var33 < 0; var23 += Rasterizer2D_width) {
                     ...
                     if (var31 >= 0 && var31 - (this.subHeight << 12) < 0) {
                        ...
                        if ((var32 = (1 + var35 - (this.subWidth << 12) - var27) / var27) > var37) {
                           var37 = var32;
                        }
   ...
   public void bz(int var1, int var2, int var3, int var4) {
      if (var3 <= this.width && var4 <= this.height) {
         int var5 = var1 + this.yOffset * var3 / this.width;
         int var6 = var1 + ((this.yOffset + this.subWidth) * var3 + this.width - 1) / this.width;
         int var7 = var2 + this.xOffset * var4 / this.height;
         int var8 = var2 + ((this.xOffset + this.subHeight) * var4 + this.height - 1) / this.height;
