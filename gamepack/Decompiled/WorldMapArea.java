            ...
            if (6506 == var0) {
               ...
               if (6512 == var0) {
                  ...
                  if (var0 == 6513) {
                     ...
                     if (var6.isString()) {
                        Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize += -1086551379) * -2017760987 - 1] = AbstractArchive.an_renamed(var4).ao(var8, var6.defaultstr);
                     } else {
                        Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = AbstractArchive.an_renamed(var4).ay(var8, -171401431 * var6.defaultint);
                     }
