public class jl {
   ...
   static final void ij_renamed(String var0, boolean var1) {
      if (Client.mj) {
         ...
         int var4 = var3 + 6;
         int var5 = var3 + 6;
         int var6 = WallDecoration.fontPlain12.ai(var0, 250);
         int var7 = WallDecoration.fontPlain12.ag(var0, 250) * 13;
         ...
         WallDecoration.fontPlain12.ak(var0, var4, var5, var6, var7, 16777215, -1, 1, 1, 0);
         int var8 = var4 - var3;
         int var9 = var5 - var3;
