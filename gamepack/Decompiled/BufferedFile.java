...
public class BufferedFile {
   ...
   public long length() {
      return this.capacity * -1243507284389482911L;
   }
      ...
      try {
         ...
         if (var3 > this.writeBuffer.length) {
            ...
            for(this.ao = -140630493748753059L * this.at; var3 > 0; var3 -= var9) {
               var9 = this.accessFile.read(var1, var2, var3);
               if (-1 == var9) {
                  break;
               }
   ...
   void load() throws IOException {
      ...
      if (this.at * 8429326271465132299L != 31144933894015367L * this.ao) {
         this.accessFile.seek(8429326271465132299L * this.at);
   ...
   public void write(byte[] var1, int var2, int var3) throws IOException {
      try {
         if (8429326271465132299L * this.at + (long)var3 > this.capacity * -1243507284389482911L) {
            this.capacity = -8298185492872661599L * ((long)var3 + this.at * 8429326271465132299L);
         }
   ...
   void flush() throws IOException {
      if (-8462239109085136939L * this.aq != -1L) {
         if (this.ao * 31144933894015367L != this.aq * -8462239109085136939L) {
            this.accessFile.seek(this.aq * -8462239109085136939L);
