public class Decimator {
   ...
   static void ai_renamed(Font var0, Font var1) {
      ...
      var0.aj(Strings.mo, cz.aw * 578342931 + 62, 15, 0, -1);
      if (null != World.dt) {
         World.dt[1].aw(cz.aw * 578342931 + 140, 1);
         var1.ar(Strings.mn, 578342931 * cz.aw + 152, 10, 16777215, -1);
         World.dt[0].aw(cz.aw * 578342931 + 140, 12);
         var1.ar(Strings.mi, 152 + cz.aw * 578342931, 21, 16777215, -1);
      }
      ...
      if (DevicePcmPlayerProvider.dk != null) {
         ...
         var0.ar(Strings.md, 32 + var23, 17, 16777215, -1);
         ...
         var0.ar(Strings.mr, 32 + var25, 17, 16777215, -1);
         ...
         var0.ar(Strings.ml, 32 + var5, 17, 16777215, -1);
         ...
         var0.ar(Strings.mf, var6 + 32, 17, 16777215, -1);
      }

      Rasterizer2D.Rasterizer2D_fillRectangle(cz.aw * 578342931 + 708, 4, 50, 16, 0);
      var1.aj(Strings.Strings_cancel, 25 + 708 + cz.aw * 578342931, 16, 16777215, -1);
      cz.de = 848889613;
      if (st.dr != null) {
         byte var24 = 88;
         byte var26 = 19;
         ...
         for(var17 = var6 * var16; var17 < World.worldsCount * -734287707 && var16 - 1246310743 * cz.dh < var5; ++var17) {
            ...
            var0.aj(Integer.toString(-2091224171 * var18.id), 15 + var13, 5 + var26 / 2 + var12, var22, -1);
            var1.aj(var20, var13 + 60, 5 + var26 / 2 + var12, 268435455, -1);
            var12 += var8 + var26;
            ++var14;
            if (var14 >= var6) {
               var12 = 23 + var10;
         ...
         if (var15) {
            var17 = var1.ao(bx.worlds[cz.de * 248569915].activity) + 6;
            int var27 = 8 + var1.al;
            ...
            var1.aj(bx.worlds[cz.de * 248569915].activity, -2063363905 * MouseHandler.ay, 4 + var1.al + var28, 0, -1);
         }
      }
   ...
   static void ir_renamed(int var0) {
      ...
      if (na.iv_renamed() == 1) {
         ClientScriptFrame.client.al(765, 503);
      } else {
         ClientScriptFrame.client.al(7680, 2160);
      }
