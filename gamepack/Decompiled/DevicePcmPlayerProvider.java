   ...
   static void hs_renamed() {
      ...
      if (-627796577 * Client.fi == 0) {
         ...
         if (-627796577 * Client.fi == 45) {
            ...
            var14.ai(9, 128);
            bi.pcmPlayer0 = fc.newPcmPlayer(Client.af, 0, 22050);
            bi.pcmPlayer0.aj(var14);
            ParamType.af_renamed(ey.fm, id.archive15, qc.archive4, var14);
            hd.pcmPlayer1 = fc.newPcmPlayer(Client.af, 1, 2048);
            ...
            if (60 == -627796577 * Client.fi) {
               ...
               if (!dk.archive3.cc()) {
                  ...
                  if (ey.archive16.cv("version.dat", "")) {
                     Packet var22 = new Packet(ey.archive16.cb("version.dat", ""));
                     var22.cl();
                  }
               ...
               cz.ad = 205815780;
               if (bi.archive12.cm() > 0 && !bi.archive12.cz(WorldMapCacheName.WorldMapCacheName_details.name)) {
                  cz.Login_loadingText = Strings.Strings_loadingWorldMap + bi.archive12.cj(WorldMapCacheName.WorldMapCacheName_details.name) / 10 + "%";
               } else {
