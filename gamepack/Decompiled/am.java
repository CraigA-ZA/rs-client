...
public class am {
   ...
   static final void drawActors2d(int var0, int var1, int var2, int var3) {
      ...
      if (1 == 986256295 * Client.lv && Client.pu * 324465533 >= 2 && 0 == Client.ep * -1886224337 % 50 && (1144428983 * MusicPatchNode.localPlayer.bx >> 7 != -1958669353 * bz.lg >> 7 || -365969735 * fw.lf >> 7 != -411750205 * MusicPatchNode.localPlayer.bo >> 7)) {
         ...
         var20.bit.eb(1263827259 * Client.ly);
         var20.bit.dy(var18);
         var20.bit.dh(var17);
         var20.bit.ds(var19);
      ...
      for(var25 = 0; var25 < Client.overheadTextCount * 734988573; ++var25) {
         ...
         if (0 == Client.py * 395188193) {
            ...
            if (0 == Client.lo[var25]) {
               fx.fontBold12.aj(var39, var0 + Client.mz * -1848743379, var1 + 318977283 * Client.mu, var32, 0);
            }

            if (Client.lo[var25] == 1) {
               fx.fontBold12.ae(var39, -1848743379 * Client.mz + var0, Client.mu * 318977283 + var1, var32, 0, Client.mw * 2041464667);
            }

            if (Client.lo[var25] == 2) {
               fx.fontBold12.ap(var39, -1848743379 * Client.mz + var0, var1 + 318977283 * Client.mu, var32, 0, Client.mw * 2041464667);
            }

            if (Client.lo[var25] == 3) {
               fx.fontBold12.by(var39, var0 + Client.mz * -1848743379, var1 + 318977283 * Client.mu, var32, 0, 2041464667 * Client.mw, 150 - Client.lw[var25]);
            }

            if (4 == Client.lo[var25]) {
               var33 = (150 - Client.lw[var25]) * (fx.fontBold12.ao(var39) + 100) / 150;
               Rasterizer2D.Rasterizer2D_expandClip(-1848743379 * Client.mz + var0 - 50, var1, var0 + Client.mz * -1848743379 + 50, var3 + var1);
               fx.fontBold12.ar(var39, 50 + var0 + -1848743379 * Client.mz - var33, var1 + Client.mu * 318977283, var32, 0);
            ...
            if (Client.lo[var25] == 5) {
               ...
               Rasterizer2D.Rasterizer2D_expandClip(var0, var1 + 318977283 * Client.mu - fx.fontBold12.al - 1, var2 + var0, 5 + 318977283 * Client.mu + var1);
               fx.fontBold12.aj(var39, var0 + Client.mz * -1848743379, var1 + 318977283 * Client.mu + var34, var32, 0);
               Rasterizer2D.Rasterizer2D_setClip(var0, var1, var2 + var0, var3 + var1);
            }
         } else {
            fx.fontBold12.aj(var39, Client.mz * -1848743379 + var0, var1 + 318977283 * Client.mu, 16776960, 0);
         }
      }
