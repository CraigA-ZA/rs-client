public class ClanMate extends Buddy {
   ...
   void at() {
      this.isIgnored0 = World.friendSystem.friendsList.bt(this.aw) ? TriBool.TriBool_true : TriBool.TriBool_false;
   }
   ...
   void ao() {
      this.isFriend0 = World.friendSystem.ignoreList.bt(this.aw) ? TriBool.TriBool_true : TriBool.TriBool_false;
   }
