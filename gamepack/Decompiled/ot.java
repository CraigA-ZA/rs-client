...
public class ot extends RuntimeException {
   ...
   static final void worldToScreen(int var0, int var1, int var2) {
      if (var0 >= 128 && var1 >= 128 && var0 <= 13056 && var1 <= 13056) {
         ...
         if (var1 >= 50) {
            Client.mz = (433849721 * Client.viewportHeight / 2 + var0 * Client.viewportZoom * -1114517553 / var1) * -846498395;
            Client.mu = -1610031701 * (Client.viewportWidth * 2042096749 / 2 + var9 * -1114517553 * Client.viewportZoom / var1);
         } else {
            Client.mz = 846498395;
