      ...
      if (!Client.isInInstance) {
         ...
         for(var6 = 0; var6 < var5; ++var6) {
            for(var7 = 0; var7 < 4; ++var7) {
               Scenery.xteaKeys[var6][var7] = var1.cx();
            }
         }
         ...
         for(var6 = (var4 - 6) / 8; var6 <= (var4 + 6) / 8; ++var6) {
            for(var7 = (var3 - 6) / 8; var7 <= (6 + var3) / 8; ++var7) {
               ...
               FontName.jm[var5] = nn.archive5.cy("m" + var6 + "_" + var7);
               Archive.jn[var5] = nn.archive5.cy("l" + var6 + "_" + var7);
               ++var5;
            }
         }
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            for(var8 = 0; var8 < 4; ++var8) {
               Scenery.xteaKeys[var7][var8] = var1.cx();
            }
         }
               ...
               for(var9 = 0; var9 < 13; ++var9) {
                  ...
                  if (-1 != var10) {
                     ...
                     if (var13 != -1) {
                        ...
                        var14 = var13 >> 8 & 255;
                        int var15 = var13 & 255;
                        FontName.jm[var6] = nn.archive5.cy("m" + var14 + "_" + var15);
                        Archive.jn[var6] = nn.archive5.cy("l" + var14 + "_" + var15);
                        ++var6;
                     }
                  }
               }
