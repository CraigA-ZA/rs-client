public class ix {
   ...
   static final void updateInterface(Component[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for(int var9 = 0; var9 < var0.length; ++var9) {
         ...
         if (null != var10 && var1 == var10.cu * 913615679 && (var10.am() || KeyHandler.getComponentClickMask(var10) != 0 || var10 == Client.pf)) {
            if (var10.bn) {
            ...
            if (11 == var10.bg * 883712245) {
               if (var10.bz(ag.iq)) {
                  if (var10.by()) {
                     fw.ma_renamed(var10);
                     WallDecoration.lz_renamed(var10.gz, var10, true);
                  }
            ...
            int var27 = 262951665 * var10.ce + var6;
            ...
            if (9 == 883712245 * var10.bg) {
               var17 = var27;
               var18 = var12;
               var19 = -794961409 * var10.cs + var27;
               ...
               var17 = var27 + var10.cs * -794961409;
            ...
            if (var28 || !var10.bn || var13 < var15 && var14 < var16) {
               if (var10.bn) {
                  ...
                  if (var10.hn) {
                     ...
                     for(var29 = (ClientScriptEvent)Client.rq.last(); null != var29; var29 = (ClientScriptEvent)Client.rq.previous()) {
                        if (var29.an && var29.af == var29.aw.fm) {
                           var29.remove();
                        }
                     }
                  }
               ...
               if (1021339961 * var10.bf == 1337) {
                  ...
                  if (1400 == var10.bf * 1021339961) {
                     ey.wt.onCycle(-2063363905 * MouseHandler.ay, MouseHandler.ao * -1224153235, var30, var27, var12, var10.cs * -794961409, var10.cc * 1473950221);
                  }

                  if (!Client.nt && var30) {
                     if (1021339961 * var10.bf == 1400) {
                        ey.wt.cs(var27, var12, -794961409 * var10.cs, 1473950221 * var10.cc, var18, var19);
                     } else {
                        my.lo_renamed(var10);
                     }
                  }
                  ...
                  if (var28) {
                     for(int var21 = 0; var21 < var10.en.length; ++var21) {
                        ...
                        if (var23) {
                           if (var21 < 10) {
                              Message.ks_renamed(1 + var21, var10.bs * 1713081171, var10.br * 55577617, -2006098851 * var10.gn, "");
                           } else if (var21 == 10) {
                              gy.kp_renamed();
                              am.kh_renamed(var10.bs * 1713081171, 55577617 * var10.br, hc.af_renamed(KeyHandler.getComponentClickMask(var10)), -2006098851 * var10.gn);
                              Client.oj = MusicPatchNode.nu_renamed(var10);
                              if (Client.oj == null) {
                                 Client.oj = Strings.at;
                              }

                              Client.ob = var10.eh + oa.colorStartTag(16777215);
                           }
                  ...
                  if (var10.bn) {
                     ...
                     boolean var31 = false;
                     if ((1 == MouseHandler.aa * 114417019 || !su.ev && 4 == 114417019 * MouseHandler.aa) && var30) {
                        var31 = true;
                     }

                     var22 = false;
                     if ((1 == -1222491879 * MouseHandler.ar || !su.ev && MouseHandler.ar * -1222491879 == 4) && MouseHandler.am * 2020601481 >= var13 && MouseHandler.as * 1163896205 >= var14 && 2020601481 * MouseHandler.am < var15 && 1163896205 * MouseHandler.as < var16) {
                        var22 = true;
                     }

                     if (var22) {
                        ol.mm_renamed(var10, MouseHandler.am * 2020601481 - var27, 1163896205 * MouseHandler.as - var12);
                     }
                     ...
                     if (1021339961 * var10.bf == 1400) {
                        ey.wt.ac(var18, var19, var30 & var31, var30 & var22);
                     }
                     ...
                     if (var10.fs) {
                        ...
                        if (var30 && 0 != -121753353 * Client.rd && null != var10.fm) {
                           var32 = new ClientScriptEvent();
                           var32.an = true;
                           var32.aw = var10;
                           var32.au = 835807251 * Client.rd;
                           var32.af = var10.fm;
                           Client.rq.addFirst(var32);
                        }

                        if (null != Client.pr || Client.nt) {
                           var22 = false;
                           var31 = false;
                           var30 = false;
                        }
                        ...
                        if (!var10.hi && var22) {
                           ...
                           if (var10.fh != null) {
                              ...
                              var32.an = true;
                              var32.aw = var10;
                              var32.ac = (MouseHandler.am * 2020601481 - var27) * -2011830585;
                        ...
                        if (var10.hi && var31 && null != var10.fl) {
                           var32 = new ClientScriptEvent();
                           var32.an = true;
                           var32.aw = var10;
                        ...
                        if (var10.hw && var30 && null != var10.fd) {
                           var32 = new ClientScriptEvent();
                           var32.an = true;
                           var32.aw = var10;
                        ...
                        int var38;
                        if (var10.fw != null && -261310919 * Client.qx > var10.hm * -1285197923) {
                           if (null != var10.fr && Client.qx * -261310919 - -1285197923 * var10.hm <= 32) {
                              label965:
                              for(var38 = -1285197923 * var10.hm; var38 < -261310919 * Client.qx; ++var38) {
                                 var24 = Client.qr[var38 & 31];

                                 for(var35 = 0; var35 < var10.fr.length; ++var35) {
                                    if (var24 == var10.fr[var35]) {
                        ...
                        if (null != var10.fv && Client.qc * -710491461 > -320567063 * var10.hu) {
                           if (null != var10.fq && -710491461 * Client.qc - var10.hu * -320567063 <= 32) {
                              label941:
                              for(var38 = var10.hu * -320567063; var38 < -710491461 * Client.qc; ++var38) {
                                 var24 = Client.qj[var38 & 31];

                                 for(var35 = 0; var35 < var10.fq.length; ++var35) {
                                    if (var24 == var10.fq[var35]) {
                                       var37 = new ClientScriptEvent();
                                       var37.aw = var10;
                                       var37.af = var10.fv;
                                       Client.rq.addFirst(var37);
                        ...
                        if (null != var10.fc && Client.qf * -744210295 > var10.hx * 610184185) {
                           if (var10.ff != null && Client.qf * -744210295 - var10.hx * 610184185 <= 32) {
                              label917:
                              for(var38 = var10.hx * 610184185; var38 < -744210295 * Client.qf; ++var38) {
                                 var24 = Client.qs[var38 & 31];

                                 for(var35 = 0; var35 < var10.ff.length; ++var35) {
                                    if (var10.ff[var35] == var24) {
                                       var37 = new ClientScriptEvent();
                                       var37.aw = var10;
                                       var37.af = var10.fc;
                                       Client.rq.addFirst(var37);
                  ...
                  if (!var10.bn) {
                     ...
                     if ((-529297769 * var10.gi >= 0 || 0 != var10.cy * 1614966389) && -2063363905 * MouseHandler.ay >= var13 && MouseHandler.ao * -1224153235 >= var14 && MouseHandler.ay * -2063363905 < var15 && -1224153235 * MouseHandler.ao < var16) {
                        if (var10.gi * -529297769 >= 0) {
                           MidiPcmStream.oh = var0[var10.gi * -529297769];
                        } else {
                     ...
                     if (var10.cl * -1273374131 > var10.cc * 1473950221) {
                        gy.ll_renamed(var10, var27 + var10.cs * -794961409, var12, var10.cc * 1473950221, var10.cl * -1273374131, -2063363905 * MouseHandler.ay, MouseHandler.ao * -1224153235);
                     }
                  }

                  if (0 == 883712245 * var10.bg) {
                     updateInterface(var0, 1713081171 * var10.bs, var13, var14, var15, var16, var27 - var10.cq * -1469632775, var12 - 1223232735 * var10.cm);
                     if (null != var10.gz) {
                        updateInterface(var10.gz, var10.bs * 1713081171, var13, var14, var15, var16, var27 - var10.cq * -1469632775, var12 - 1223232735 * var10.cm);
                     }

                     InterfaceParent var33 = (InterfaceParent)Client.oc.get((long)(var10.bs * 1713081171));
                     if (var33 != null) {
                        if (0 == -1702664641 * var33.an && -2063363905 * MouseHandler.ay >= var13 && MouseHandler.ao * -1224153235 >= var14 && MouseHandler.ay * -2063363905 < var15 && -1224153235 * MouseHandler.ao < var16 && !Client.nt) {
