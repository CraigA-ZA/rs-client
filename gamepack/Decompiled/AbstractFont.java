            ...
            if (var7 == '<') {
               ...
               if (var4 == -1) {
                  ...
                  if (AbstractFont_strike != -1) {
                     ec_renamed(var2, var3 + (int)((double)this.ascent * 0.7), var10, AbstractFont_strike);
                  }

                  if (AbstractFont_underline != -1) {
                     ec_renamed(var2, var3 + this.ascent + 1, var10, AbstractFont_underline);
                  }
         ...
         if (var1.charAt(var9) != 0) {
            ...
            if (var10 == '<') {
               ...
               if (var6 == -1) {
                  ...
                  if (AbstractFont_strike != -1) {
                     ec_renamed(var2, var3 + (int)((double)this.ascent * 0.7), var15, AbstractFont_strike);
                  }

                  if (AbstractFont_underline != -1) {
                     ec_renamed(var2, var3 + this.ascent, var15, AbstractFont_underline);
                  }
