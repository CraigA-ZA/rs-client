...
public class WorldMapRegion {
   ...
   void aa(List var1) {
      ...
      while(var3.hasNext()) {
         ...
         if (nf.getMapElementType(1767565411 * var4.af).ao && var4.aq.x * -96298701 >> 6 == this.y * -2122501643 && this.x * 1858063995 == -2105445199 * var4.aq.z >> 6) {
   ...
   void bi(AbstractWorldMapIcon var1, MapElementType var2, int var3, int var4, float var5) {
      ...
      if (null != var7) {
         if (var7.size.af(var5)) {
            ...
            var8.ak(var7.text, var3 - var7.width * -31821843 / 2, var4, var7.width * -31821843, -1401615011 * var7.height, -16777216 | 1080412371 * var2.at, 0, 1, 0, var8.al / 2);
         }
      }
   }
