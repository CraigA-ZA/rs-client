public class PacketBit extends Packet {
   ...
   public void pIsaac1(int var1) {
      this.al[(this.at += -1516355947) * -1633313603 - 1] = (byte)(var1 + this.af.af());
   }

   public int gIsaac1() {
      return this.al[(this.at += -1516355947) * -1633313603 - 1] - this.af.af() & 255;
   }

   public boolean au(byte var1) {
      int var2 = this.al[-1633313603 * this.at] - this.af.an() & 255;
      if (var2 < 128) {
         if (var1 == -1) {
   ...
   public int gIsaacSmart1or2() {
      int var2 = this.al[(this.at += -1516355947) * -1633313603 - 1] - this.af.af() & 255;
      return var2 < 128 ? var2 : (var2 - 128 << 8) + (this.al[(this.at += -1516355947) * -1633313603 - 1] - this.af.af() & 255);
   }

   public void aq(byte[] var1, int var2, int var3) {
      for(int var5 = 0; var5 < var3; ++var5) {
         var1[var2 + var5] = (byte)(this.al[(this.at += -1516355947) * -1633313603 - 1] - this.af.af());
      }
