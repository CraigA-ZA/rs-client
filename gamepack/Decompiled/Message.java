public class Message extends DualNode {
   ...
   void ac() {
      this.isFromFriend0 = World.friendSystem.friendsList.bt(this.senderUsername) ? TriBool.TriBool_true : TriBool.TriBool_false;
   }
   ...
   void aq() {
      this.isFromIgnored0 = World.friendSystem.ignoreList.bt(this.senderUsername) ? TriBool.TriBool_true : TriBool.TriBool_false;
   }
