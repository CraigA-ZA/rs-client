public class FriendSystem {
   ...
   final boolean aq(Username var1) {
      if (null == var1) {
         ...
         return this.ignoreList.bt(var1);
      }
   }
   ...
   final boolean ao() {
      return this.friendsList.bd() || this.friendsList.bm() >= 200 && -1811511707 * Client.mo != 1;
   }
   ...
   final boolean am(Username var1) {
      Friend var3 = (Friend)this.friendsList.bj(var1);
      return null != var3 && var3.ba();
   }
   ...
   final boolean ag() {
      return this.ignoreList.bd() || this.ignoreList.bm() >= 100 && Client.mo * -1811511707 != 1;
   }
