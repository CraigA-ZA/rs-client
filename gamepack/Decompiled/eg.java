public class eg extends AbstractUserComparator {
   ...
   static int bd_renamed(int var0, ClientScript var1, boolean var2) {
      if (var0 == 5000) {
         ...
         PacketBitNode var14 = mi.an_renamed(ClientProt.cs, Client.packetWriter.au);
         var14.bit.bu(-1963411823 * Client.sj);
         var14.bit.bu(1843384107 * FloorUnderlayType.sn.ac);
         var14.bit.bu(-839909513 * Client.su);
         ...
         if (var0 == 5002) {
            ...
            var9 = Interpreter.Interpreter_intStack[-964267539 * Interpreter.Interpreter_intStackSize];
            ...
            if (5003 == var0) {
               Interpreter.Interpreter_intStackSize -= 854271946;
               var8 = Interpreter.Interpreter_intStack[-964267539 * Interpreter.Interpreter_intStackSize];
               ...
               if (var6 != null) {
                  ...
                  Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = var6.type * -524761677;
                  ...
                  Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize += -1086551379) * -2017760987 - 1] = var6.sender != null ? var6.sender : "";
               ...
               if (5004 == var0) {
                  ...
                  if (null != var5) {
                     Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = -53488167 * var5.cycle;
                     Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = var5.type * -524761677;
                     Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize += -1086551379) * -2017760987 - 1] = null != var5.text ? var5.text : "";
                     ...
                     Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize += -1086551379) * -2017760987 - 1] = var5.sender != null ? var5.sender : "";
                  ...
                  if (var0 == 5008) {
                     ...
                     String var10 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize * -2017760987 + 1];
                     var12 = mi.an_renamed(ClientProt.aq, Client.packetWriter.au);
                     var12.bit.p2(0);
                     int var13 = -1633313603 * var12.bit.index;
                     var12.bit.bh(var4);
                     WorldMapArea.an_renamed(var12.bit, var10);
                     var12.bit.ca(var12.bit.index * -1633313603 - var13);
                     Client.packetWriter.aw(var12);
                     return 1;
                  } else if (var0 == 5010) {
                     var4 = Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize -= -1086551379) * -2017760987];
                     Interpreter.Interpreter_intStackSize -= 854271946;
                     var9 = Interpreter.Interpreter_intStack[-964267539 * Interpreter.Interpreter_intStackSize];
                     var11 = Interpreter.Interpreter_intStack[1 + -964267539 * Interpreter.Interpreter_intStackSize];
                     ...
                     if (5016 == var0) {
                        ...
                        var8 = Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize -= 427135973) * -964267539];
                        Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = World.ab_renamed(var8);
                        return 1;
                     } else if (var0 == 5018) {
                        var8 = Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize -= 427135973) * -964267539];
                        Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = ir.ay_renamed(var8);
                        return 1;
                     } else if (5019 == var0) {
                        var8 = Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize -= 427135973) * -964267539];
                        Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = er.aa_renamed(var8);
                        return 1;
                     } else if (var0 == 5020) {
                        var4 = Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize -= -1086551379) * -2017760987];
                        ...
                        Interpreter.Interpreter_intStackSize -= 854271946;
                        var8 = Interpreter.Interpreter_intStack[-964267539 * Interpreter.Interpreter_intStackSize];
                        var9 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize * -964267539 + 1];
                        var6 = Actor.ac_renamed(var8, var9);
                        if (null != var6) {
                        ...
                        var5 = MouseRecorder.au_renamed(var8);
                        if (null != var5) {
                           Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = var5.cycle * -53488167;
                           Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = -524761677 * var5.type;
                           Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize += -1086551379) * -2017760987 - 1] = null != var5.text ? var5.text : "";
