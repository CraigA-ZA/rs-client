public class Inventory extends Node {
   static boolean sv;
   static int gf;
   static NodeHashTable af = new NodeHashTable(32);
   int[] an = new int[]{-1};
   int[] aw = new int[]{0};
   ...
   public static SpotType getSpotType(int var0) {
      SpotType var2 = (SpotType)SpotType.aw.get((long)var0);
      if (var2 != null) {
         return var2;
      } else {
         byte[] var3 = SpotType.af.takeFile(13, var0);
         var2 = new SpotType();
         ...
         SpotType.aw.put(var2, (long)var0);
         return var2;
      }
   }

   public static SeqType getSeqType(int var0, byte var1) {
      SeqType var2 = (SeqType)SeqType.al.get((long)var0);
      if (null != var2) {
         if (var1 <= -1) {
         ...
         byte[] var3 = SeqType.au.takeFile(12, var0);
         var2 = new SeqType();
         if (var3 != null) {
            if (var1 <= -1) {
               throw new IllegalStateException();
