         ...
         try {
            if (NetCache.an * -942339237 > 30000) {
               ...
               while(-1952694793 * NetCache.aq < 200 && NetCache.au * -1171541559 > 0) {
                  ...
                  var5 = new Packet(4);
                  var5.bu(1);
                  var5.bq((int)var4.key);
                  NetCache.af.ab(var5.array, 0, 4);
                  NetCache.ab.put(var4, var4.key);
                  ...
                  if (var6 > 0) {
                     ...
                     if (var7 == NetCache.ah.index * -1633313603) {
                        if (ClientScript.NetCache_currentResponse.key == 16711935L) {
                           ...
                           ClientScript.NetCache_currentResponse.archive.write((int)(ClientScript.NetCache_currentResponse.key & 65535L), NetCache.ah.array, 16711680L == (ClientScript.NetCache_currentResponse.key & 16711680L), NetCache.ax);
                        }

                        ClientScript.NetCache_currentResponse.remove();
                        if (NetCache.ax) {
                           NetCache.aq -= -1677618233;
                        } else {
                           NetCache.ao -= -979537415;
