...
public abstract class ia {
   ...
   static final void jc_renamed(boolean var0) {
      for(int var2 = 0; var2 < 265474485 * Client.npcCount; ++var2) {
         Npc var3 = Client.npcs[Client.npcIndices[var2]];
         if (var3 != null && var3.isVisible() && var0 == var3.type.visible && var3.type.aa()) {
            ...
            if (var4 >= 0 && var4 < 104 && var5 >= 0 && var5 < 104) {
               ...
               long var6 = FaceNormal.aa_renamed(0, 0, 1, !var3.type.interactable, Client.npcIndices[var2]);
