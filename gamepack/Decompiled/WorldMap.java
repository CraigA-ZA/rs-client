...
public class WorldMap {
   ...
   public void draw(int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var8 < 100) {
         ...
         if (var11 && this.ck && this.mouseCoord != null) {
            this.font.ar("Coord: " + this.mouseCoord, 10 + Rasterizer2D.Rasterizer2D_xClipStart, 20 + Rasterizer2D.Rasterizer2D_yClipStart, 16776960, -1);
         }
   ...
   void ae(int var1, int var2, int var3, int var4, int var5) {
      ...
      this.font.aj(Strings.Strings_loading, var8, var7 + var9, -1, -1);
   }
