            ...
            if (4104 == var0) {
               ...
               if (4106 == var0) {
                  ...
                  if (var0 == 4108) {
                     ...
                     var15 = ei.fg.bh(var12, 0);
                     var17 = new Font(var15);
                     Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = var17.ag(var4, var10);
                     return 1;
                  } else if (var0 == 4109) {
                     var4 = Interpreter.Interpreter_stringStack[(SecureRandomCallable.Interpreter_stringStackSize -= -1086551379) * -2017760987];
                     Interpreter.Interpreter_intStackSize -= 854271946;
                     ...
                     var15 = ei.fg.bh(var12, 0);
                     var17 = new Font(var15);
                     Interpreter.Interpreter_intStack[(Interpreter.Interpreter_intStackSize += 427135973) * -964267539 - 1] = var17.ai(var4, var10);
                     return 1;
                  } else if (var0 == 4110) {
                     SecureRandomCallable.Interpreter_stringStackSize -= 2121864538;
                     var4 = Interpreter.Interpreter_stringStack[SecureRandomCallable.Interpreter_stringStackSize * -2017760987];
