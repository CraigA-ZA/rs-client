...
public class CamelliaEngine implements BlockCipher {
   ...
   void int2bytes(int var1, byte[] var2, int var3) {
   ...
   static void decroldqo32(int var0, int[] var1, int var2, int[] var3, int var4) {
   ...
   static void roldq(int var0, int[] var1, int var2, int[] var3, int var4) {
   ...
   int processBlock128(byte[] var1, int var2, byte[] var3, int var4) {
      int[] var10000;
   ...
   void camelliaF2(int[] var1, int[] var2, int var3) {
   ...
   void camelliaFLs(int[] var1, int[] var2, int var3) {
   ...
   void setKey(boolean var1, byte[] var2) {
      int[] var3 = new int[8];
      int[] var4 = new int[4];
      int[] var5 = new int[4];
      int[] var6 = new int[4];
   ...
   int bytes2int(byte[] var1, int var2) {
      int var3 = 0;
   ...
   static void decroldq(int var0, int[] var1, int var2, int[] var3, int var4) {
   ...
   static void roldqo32(int var0, int[] var1, int var2, int[] var3, int var4) {
   ...
   int processBlock192or256(byte[] var1, int var2, byte[] var3, int var4) {
      int[] var10000;
      for(int var5 = 0; var5 < 4; ++var5) {
         this.state[var5] = this.bytes2int(var1, var2 + var5 * 4);
         var10000 = this.state;
   ...
   static int rightRotate(int var0, int var1) {
      return (var0 >>> var1) + (var0 << 32 - var1);
   }
