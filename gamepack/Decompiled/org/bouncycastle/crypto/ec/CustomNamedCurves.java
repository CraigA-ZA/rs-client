...
public class CustomNamedCurves {
   ...
   static void defineCurve(String var0, X9ECParametersHolder var1) {
      ...
      var0 = org.bouncycastle.util.Strings.toLowerCase(var0);
   ...
   public static X9ECParameters getByName(String var0) {
      X9ECParametersHolder var1 = (X9ECParametersHolder)nameToCurve.get(org.bouncycastle.util.Strings.toLowerCase(var0));
      return var1 == null ? null : var1.getParameters();
   }

   public static ASN1ObjectIdentifier getOID(String var0) {
      return (ASN1ObjectIdentifier)nameToOID.get(org.bouncycastle.util.Strings.toLowerCase(var0));
   }
