      ...
      if (this.isInfinity()) {
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               ECFieldElement var15 = var8.multiply(var11).add(var10).multiplyPlusProduct(var13, var9, var11);
               ...
               if (var17.isZero()) {
                  ...
                  return new SecT571R1Point(var2, var15, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
               } else {
                  ...
                  return new SecT571R1Point(var2, var18, var20, new ECFieldElement[]{var19}, this.withCompression);
               }
            } else {
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var8.isZero()) {
               return new SecT571R1Point(var1, var8, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            } else {
               ...
               return new SecT571R1Point(var1, var9, var12, new ECFieldElement[]{var10}, this.withCompression);
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT571R1Point(var2, var17, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
                  }
               ...
               return new SecT571R1Point(var2, var17, var18, new ECFieldElement[]{var19}, this.withCompression);
            }
         }
      }
   }
