...
public class ASN1GeneralizedTime extends ASN1Primitive {
   ...
   public String getTimeString() {
      return org.bouncycastle.util.Strings.fromByteArray(this.time);
   }

   public String getTime() {
      String var1 = org.bouncycastle.util.Strings.fromByteArray(this.time);
   ...
   public ASN1GeneralizedTime(Date var1, Locale var2) {
      ...
      this.time = org.bouncycastle.util.Strings.toByteArray(var3.format(var1));
   }

   public Date getDate() throws ParseException {
      String var2 = org.bouncycastle.util.Strings.fromByteArray(this.time);
      String var3 = var2;
   ...
   public ASN1GeneralizedTime(String var1) {
      this.time = org.bouncycastle.util.Strings.toByteArray(var1);
   ...
   public ASN1GeneralizedTime(Date var1) {
      ...
      this.time = org.bouncycastle.util.Strings.toByteArray(var2.format(var1));
   }
