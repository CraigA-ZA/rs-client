...
public class IETFUtils {
   ...
   public static ASN1ObjectIdentifier decodeAttrName(String var0, Hashtable var1) {
      if (org.bouncycastle.util.Strings.toUpperCase(var0).startsWith("OID.")) {
         ...
         ASN1ObjectIdentifier var2 = (ASN1ObjectIdentifier)var1.get(org.bouncycastle.util.Strings.toLowerCase(var0));
         if (var2 == null) {
   ...
   static boolean isHexDigit(char var0) {
      return '0' <= var0 && var0 <= '9' || 'a' <= var0 && var0 <= 'f' || 'A' <= var0 && var0 <= 'F';
   }

   static int convertHex(char var0) {
      if ('0' <= var0 && var0 <= '9') {
         return var0 - 48;
      } else {
   ...
   static String[] toValueArray(Vector var0) {
   ...
   static ASN1ObjectIdentifier[] toOIDArray(Vector var0) {
   ...
   static boolean atvAreEqual(AttributeTypeAndValue var0, AttributeTypeAndValue var1) {
      if (var0 == var1) {
         return true;
      } else if (var0 == null) {
         return false;
   ...
   public static String canonicalize(String var0) {
      String var1 = org.bouncycastle.util.Strings.toLowerCase(var0);
      if (var1.length() > 0 && var1.charAt(0) == '#') {
         ASN1Primitive var2 = decodeObject(var1);
         if (var2 instanceof ASN1String) {
            var1 = org.bouncycastle.util.Strings.toLowerCase(((ASN1String)var2).getString());
         }
      }
   ...
   static ASN1Primitive decodeObject(String var0) {
      try {
