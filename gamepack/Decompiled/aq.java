public class aq implements Enumerated {
   ...
   static void aa_renamed(boolean var0) {
      if (!ClientScriptFrame.bc.gn() && !ClientScriptFrame.bc.gx() && !ClientScriptFrame.bc.gv()) {
         cz.cs = Strings.ir;
         cz.cc = Strings.io;
         cz.cn = Strings.ip;
         ee.ak_renamed(2);
   ...
   static void drawTitle(Font var0, Font var1, Font var2) {
      ...
      if (cz.di) {
         ...
         if (Client.dw * -1275976559 == 0 || Client.dw * -1275976559 == 5) {
            ...
            var0.drawCentered(cz.ae, 180 + cz.ak * 678588245, 276 - var4, 16777215, -1);
         }
         ...
         if (Client.dw * -1275976559 == 20) {
            cz.au.aw(cz.ak * 678588245 + 180 - cz.au.aw / 2, 271 - cz.au.ac / 2);
            var4 = 201;
            var0.drawCentered(cz.cs, 180 + 678588245 * cz.ak, var4, 16776960, 0);
            var4 += 15;
            var0.drawCentered(cz.cc, cz.ak * 678588245 + 180, var4, 16776960, 0);
            var4 += 15;
            var0.drawCentered(cz.cn, cz.ak * 678588245 + 180, var4, 16776960, 0);
            var4 += 15;
            var4 += 7;
            if (4 != cz.ce * 1145608355 && 10 != 1145608355 * cz.ce) {
               var0.draw(Strings.jy, cz.ak * 678588245 + 180 - 110, var4, 16777215, 0);
               var18 = 200;
               ...
               var0.draw(Strings.jp + var7, 180 + cz.ak * 678588245 - 108, var4, 16777215, 0);
               var4 += 15;
            }
         }
         ...
         if (10 == Client.dw * -1275976559 || Client.dw * -1275976559 == 11 || Client.dw * -1275976559 == 50) {
            ...
            if (0 == cz.ce * 1145608355) {
               var19 = 251;
               var0.drawCentered(Strings.ja, 678588245 * cz.ak + 180, var19, 16776960, 0);
               var4 = var19 + 30;
               var5 = 180 + 678588245 * cz.ak - 80;
               var20 = 291;
               lu.ab.aw(var5 - 73, var20 - 20);
               var0.drawLines(Strings.jb, var5 - 73, var20 - 20, 144, 40, 16777215, 0, 1, 1, 0);
               var5 = 180 + 678588245 * cz.ak + 80;
               lu.ab.aw(var5 - 73, var20 - 20);
               var0.drawLines(Strings.jz, var5 - 73, var20 - 20, 144, 40, 16777215, 0, 1, 1, 0);
            } else if (1 == 1145608355 * cz.ce) {
               var0.drawCentered(cz.ci, 678588245 * cz.ak + 180, 201, 16776960, 0);
               var19 = 236;
               var0.drawCentered(cz.cs, 678588245 * cz.ak + 180, var19, 16777215, 0);
               var4 = var19 + 15;
               var0.drawCentered(cz.cc, cz.ak * 678588245 + 180, var4, 16777215, 0);
               var4 += 15;
               var0.drawCentered(cz.cn, cz.ak * 678588245 + 180, var4, 16777215, 0);
               var4 += 15;
               var5 = 678588245 * cz.ak + 180 - 80;
               var20 = 321;
               lu.ab.aw(var5 - 73, var20 - 20);
               var0.drawCentered(Strings.aq, var5, var20 + 5, 16777215, 0);
               var5 = cz.ak * 678588245 + 180 + 80;
               lu.ab.aw(var5 - 73, var20 - 20);
               var0.drawCentered(Strings.jl, var5, 5 + var20, 16777215, 0);
            } else {
               int var8;
               if (1145608355 * cz.ce == 2) {
                  var19 = 201;
                  var0.drawCentered(cz.cs, fy.az * 950254081, var19, 16776960, 0);
                  var4 = var19 + 15;
                  var0.drawCentered(cz.cc, 950254081 * fy.az, var4, 16776960, 0);
                  var4 += 15;
                  var0.drawCentered(cz.cn, fy.az * 950254081, var4, 16776960, 0);
                  var4 += 15;
                  var4 += 7;
                  var0.draw(Strings.jy, 950254081 * fy.az - 110, var4, 16777215, 0);
                  var18 = 200;

                  for(var6 = am.aw_renamed(); var0.stringWidth(var6) > var18; var6 = var6.substring(1)) {
                  }

                  var0.draw(AbstractFont.escapeBrackets(var6) + (0 == cz.dm * -1232221421 & Client.ep * -1886224337 % 40 < 20 ? oa.colorStartTag(16776960) + Formatting.aw : ""), 950254081 * fy.az - 70, var4, 16777215, 0);
                  var4 += 15;

                  for(var7 = mc.ai_renamed(cz.cu); var0.stringWidth(var7) > var18; var7 = var7.substring(1)) {
                  }

                  var0.draw(Strings.jp + var7 + (-1232221421 * cz.dm == 1 & Client.ep * -1886224337 % 40 < 20 ? oa.colorStartTag(16776960) + Formatting.aw : ""), 950254081 * fy.az - 108, var4, 16777215, 0);
                  var4 += 15;
                  var19 = 277;
                  ...
                  lu.ab.aw(var16 - 73, var17 - 20);
                  var0.drawCentered(Strings.jl, var16, 5 + var17, 16777215, 0);
                  var19 = 357;
                  ...
                  if (cz.ce * 1145608355 == 4) {
                     ...
                     var0.drawCentered(cz.cs, 678588245 * cz.ak + 180, var19, 16777215, 0);
                     var4 = var19 + 15;
                     var0.drawCentered(cz.cc, 180 + cz.ak * 678588245, var4, 16777215, 0);
                     var4 += 15;
                     var0.drawCentered(cz.cn, 678588245 * cz.ak + 180, var4, 16777215, 0);
                     var4 += 15;
                     var0.draw(Strings.jt + mc.ai_renamed(Messages.cp) + (-1886224337 * Client.ep % 40 < 20 ? oa.colorStartTag(16776960) + Formatting.aw : ""), cz.ak * 678588245 + 180 - 108, var4, 16777215, 0);
                     var4 -= 8;
                     ...
                     var0.drawCentered(Strings.aq, var8, var22 + 5, 16777215, 0);
                     var8 = 80 + cz.ak * 678588245 + 180;
                     lu.ab.aw(var8 - 73, var22 - 20);
                     var0.drawCentered(Strings.jl, var8, 5 + var22, 16777215, 0);
                     ...
                     var19 = 221;
                     var2.drawCentered(cz.cs, 678588245 * cz.ak + 180, var19, 16776960, 0);
                     var4 = var19 + 15;
                     var2.drawCentered(cz.cc, 180 + 678588245 * cz.ak, var4, 16776960, 0);
                     var4 += 15;
                     var2.drawCentered(cz.cn, 180 + 678588245 * cz.ak, var4, 16776960, 0);
                     var4 += 15;
                     var4 += 14;
                     ...
                     var0.draw(AbstractFont.escapeBrackets(var6) + (-1886224337 * Client.ep % 40 < 20 ? oa.colorStartTag(16776960) + Formatting.aw : ""), cz.ak * 678588245 + 180 - 34, var4, 16777215, 0);
                     var4 += 15;
                     ...
                     if (6 == cz.ce * 1145608355) {
                        var19 = 201;
                        var0.drawCentered(cz.cs, 180 + cz.ak * 678588245, var19, 16776960, 0);
                        var4 = var19 + 15;
                        var0.drawCentered(cz.cc, 180 + cz.ak * 678588245, var4, 16776960, 0);
                        var4 += 15;
                        var0.drawCentered(cz.cn, 678588245 * cz.ak + 180, var4, 16776960, 0);
                        var4 += 15;
                        ...
                        if (WorldMapSectionType.ds && !Client.cy) {
                           var19 = 201;
                           var0.drawCentered(cz.cs, 950254081 * fy.az, var19, 16776960, 0);
                           var4 = var19 + 15;
                           var0.drawCentered(cz.cc, 950254081 * fy.az, var4, 16776960, 0);
                           var4 += 15;
                           var0.drawCentered(cz.cn, 950254081 * fy.az, var4, 16776960, 0);
                           ...
                           for(var20 = 0; var20 < 8; ++var20) {
                              ...
                              var0.draw((cz.cm[var20] == null ? "" : cz.cm[var20]) + (var26 ? oa.colorStartTag(16776960) + Formatting.aw : ""), var5 + 10, 27 + var4, 16777215, 0);
                              if (1 != var20 && 3 != var20) {
                                 var5 += 35;
                              } else {
                                 var5 += 50;
                           ...
                           lu.ab.aw(var20 - 73, var27 - 20);
                           var0.drawCentered(Strings.jl, var20, var27 + 5, 16777215, 0);
                        } else {
                           var19 = 216;
                        ...
                        var19 = 221;
                        var0.drawCentered(cz.cs, 180 + 678588245 * cz.ak, var19, 16776960, 0);
                        var4 = var19 + 25;
                        var0.drawCentered(cz.cc, 678588245 * cz.ak + 180, var4, 16776960, 0);
                        var4 += 25;
                        var0.drawCentered(cz.cn, 180 + cz.ak * 678588245, var4, 16776960, 0);
                        var5 = 180 + cz.ak * 678588245;
                        var24 = 311;
                        lu.ab.aw(var5 - 73, var24 - 20);
                        ...
                        var18 = 209;
                        var0.drawCentered(Strings.ja, 180 + 678588245 * cz.ak, var18, 16776960, 0);
                        var5 = var18 + 20;
                        ...
                        var0.drawCentered(cz.cs, 678588245 * cz.ak + 180, var19, 16777215, 0);
                        var4 = var19 + 15;
                        var0.drawCentered(cz.cc, 678588245 * cz.ak + 180, var4, 16777215, 0);
                        var4 += 15;
                        var0.drawCentered(cz.cn, 678588245 * cz.ak + 180, var4, 16777215, 0);
                        var4 += 15;
                        ...
                        var24 = 301;
                        lu.ab.aw(var5 - 73, var24 - 20);
                        var0.drawCentered(Strings.au, var5, var24 + 5, 16777215, 0);
                        ...
                        var0.drawCentered(cz.cs, 180 + cz.ak * 678588245, var19, 16776960, 0);
                        var4 = var19 + 20;
                        var1.drawCentered(cz.cc, 180 + cz.ak * 678588245, var4, 16776960, 0);
                        var4 += 20;
                        var1.drawCentered(cz.cn, 180 + cz.ak * 678588245, var4, 16776960, 0);
                        var4 += 15;
                        var5 = 180 + 678588245 * cz.ak;
                        var24 = 276;
                        lu.ab.aw(var5 - 73, var24 - 20);
         ...
         fc.ao[aj.vb.aa() ? 1 : 0].aw(765 + cz.aw * 578342931 - 40, 463);
         if (-1275976559 * Client.dw > 5 && Language.af == fj.ck) {
            if (mv.dv != null) {
               ...
               byte var28 = 35;
               mv.dv.aw(var4, var18);
               var0.drawCentered(Strings.gx + " " + Client.bw * -453810525, var30 / 2 + var4, var18 + var28 / 2 - 2, 16777215, 0);
               if (ao.aa != null) {
                  var1.drawCentered(Strings.mb, var30 / 2 + var4, 12 + var28 / 2 + var18, 16777215, 0);
               } else {
                  var1.drawCentered(Strings.nz, var4 + var30 / 2, var28 / 2 + var18 + 12, 16777215, 0);
               }
            } else {
               mv.dv = MusicPatchNode2.au_renamed(rr.fv, "sl_button", "");
            }
         }
