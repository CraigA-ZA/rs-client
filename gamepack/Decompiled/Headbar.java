public class Headbar extends Node {
   ...
   HeadbarUpdate get(int var1) {
      ...
      if (null != var3 && -1225111563 * var3.cycle <= var1) {
         for(HeadbarUpdate var4 = (HeadbarUpdate)this.updates.previous(); null != var4 && -1225111563 * var4.cycle <= var1; var4 = (HeadbarUpdate)this.updates.previous()) {
            var3.remove();
            var3 = var4;
         }

         if (this.type.int5 * -407931959 + -2116244499 * var3.cycleOffset + -1225111563 * var3.cycle > var1) {
            return var3;
         } else {
            var3.remove();
            return null;
   ...
   public static ClientError an(Throwable var0, String var1) {
      ClientError var2;
