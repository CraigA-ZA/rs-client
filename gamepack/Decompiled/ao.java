                  ...
                  if (var11.clientCode * 1021339961 != 0) {
                     if (1021339961 * var11.clientCode == 1336) {
                        if (aj.clientPreferences.ax()) {
                           var14 += 15;
                           WallDecoration.fontPlain12.as("Fps:" + Client.aa * 1913114939, var13 + -794961409 * var11.width, var14, 16776960, -1);
                           var14 += 15;
                           ...
                           WallDecoration.fontPlain12.as("Mem:" + var21 + "k", var13 + -794961409 * var11.width, var14, var22, -1);
                           var14 += 15;
                        }
                        continue;
                     }
                           ...
                           if (5 == 883712245 * var11.bg) {
                              ...
                              if (883712245 * var11.bg == 6) {
                                 ...
                                 if (-1 != -2006098851 * var11.itemId) {
                                    ...
                                    var36 = var11.dd.aa((SeqType)null, -1, Inventory.getSeqType(MusicPatchNode.localPlayer.bt * 1590591885, (byte)121), 424813829 * MusicPatchNode.localPlayer.cw);
                                 } else {
                                    hs var39 = null;
                                    hv var40 = null;
                                 ...
                                 if (8 == var11.bg * 883712245 && fe.os == var11 && Client.on * 1239377975 == Client.oe * 215597333) {
                                    ...
                                    for(var34 = em.lp_renamed(var34, var11); var34.length() > 0; var27 += 1 + var31.al) {
                                       ...
                                       var31.ar(var24, var25 + 3, var27, 0, -1);
                                    }
                                 }
