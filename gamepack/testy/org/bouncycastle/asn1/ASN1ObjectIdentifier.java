...
public class ASN1ObjectIdentifier extends ASN1Primitive {
   ...
   static final long LONG_LIMIT = 72057594037927808L;
   byte[] body;
   ...
   void writeField(ByteArrayOutputStream var1, long var2) {
   ...
   void writeField(ByteArrayOutputStream var1, BigInteger var2) {
   ...
   void doOutput(ByteArrayOutputStream var1) {
   ...
   static boolean isValidBranchID(String var0, int var1) {
      boolean var2 = false;
   ...
   static boolean isValidIdentifier(String var0) {
