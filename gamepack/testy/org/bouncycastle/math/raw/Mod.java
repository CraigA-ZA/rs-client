...
public abstract class Mod {
   static void inversionResult(int[] var0, int var1, int[] var2, int[] var3) {
      if (var1 < 0) {
   ...
   static int getTrailingZeroes(int var0) {
      int var1;
   ...
   static int inversionStep(int[] var0, int[] var1, int var2, int[] var3, int var4) {
