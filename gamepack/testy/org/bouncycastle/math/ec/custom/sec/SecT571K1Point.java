         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT571K1Point(var2, var17, var2.getB(), this.withCompression);
                  }
               ...
               return new SecT571K1Point(var2, var17, var18, new ECFieldElement[]{var19}, this.withCompression);
            }
         }
      }
   }
