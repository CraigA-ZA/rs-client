         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var17.isZero()) {
                  ...
                  return new SecT163K1Point(var2, var15, var2.getB(), this.withCompression);
               } else {
                  ...
                  return new SecT163K1Point(var2, var18, var20, new ECFieldElement[]{var19}, this.withCompression);
               }
            } else {
