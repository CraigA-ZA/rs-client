import accessors.RSIndexedSprite;

public final class tc extends th implements RSIndexedSprite {
   public int aq;
   public int[] an;
   public int aw;
   public int ac;
   ...
   static void av(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   static void ag(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   public void aw(int var1, int var2) {
      ...
      if (var6 > 0 && var5 > 0) {
         ac(ad, this.af, this.an, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void ar(int var1, int var2, int var3, int var4) {
      ...
      ab(ad, this.af, this.an, var7, var8, var13, var14, var3, var4, var11, var12, var5);
   }
   ...
   static void ab(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   static void ah(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   static void ac(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   static void ak(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
      ...
      for(int var13 = -var8; var13 < 0; ++var13) {
         ...
         for(int var15 = -var7; var15 < 0; ++var15) {
            byte var16 = var1[(var3 >> 16) + var14];
            if (var16 != 0) {
               var0[var5++] = var2[var16 & 1796849801];
            } else {
               ++var5;
            }
