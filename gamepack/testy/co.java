...
public class co {
   ...
   public static int ab(int var0, int var1) {
      try {
         ...
         throw db.an(var2, "co.ab(" + ')');
      }
   }

   static double ao(int var0, int var1, int var2, int var3) {
      try {
         double var10000;
         if (var1 > 0) {
            if (var3 >= 759235360) {
               ...
               switch (var2) {
                  ...
                  case 6:
                     if (var4 < 0.5) {
                        ...
                        var10000 = var4 * var4 * 2.0;
                     } else {
                        var10000 = 1.0 - Math.pow(2.0 + var4 * -2.0, 2.0) / 2.0;
                     }
                  ...
                  case 9:
                     if (var4 < 0.5) {
                        ...
                        var10000 = 4.0 * var4 * var4 * var4;
                     } else {
                        var10000 = 1.0 - Math.pow(2.0 + -2.0 * var4, 3.0) / 2.0;
                     }
                  ...
                  case 12:
                     if (var4 < 0.5) {
                        ...
                        var10000 = var4 * var4 * var4 * var4 * 8.0;
                     } else {
                        var10000 = 1.0 - Math.pow(var4 * -2.0 + 2.0, 4.0) / 2.0;
                     }
                  ...
                  case 15:
                     if (var4 < 0.5) {
                        ...
                        var10000 = var4 * var4 * var4 * 8.0 * var4 * var4;
                     } else {
                        var10000 = 1.0 - Math.pow(var4 * -2.0 + 2.0, 5.0) / 2.0;
                     }
                  ...
                  case 18:
                     if (var4 < 0.5) {
                        ...
                        var10000 = Math.pow(2.0, 20.0 * var4 + 10.0) / 2.0;
                     } else {
                        var10000 = (2.0 - Math.pow(2.0, 10.0 + var4 * -20.0)) / 2.0;
                     }
                  ...
                  case 21:
                     if (var4 < 0.5) {
                        ...
                        var10000 = (1.0 - Math.sqrt(1.0 - Math.pow(2.0 * var4, 2.0))) / 2.0;
                     } else {
                        var10000 = (Math.sqrt(1.0 - Math.pow(2.0 + -2.0 * var4, 2.0)) + 1.0) / 2.0;
                     }
                  ...
                  case 24:
                     ...
                     if (var4 < 0.5) {
                        ...
                        var10000 = Math.pow(2.0 * var4, 2.0) * (7.189819 * var4 - 2.5949095) / 2.0;
                     } else {
                        var10000 = (Math.pow(var4 * 2.0 - 2.0, 2.0) * (2.5949095 + (var4 * 2.0 - 2.0) * 3.5949095) + 2.0) / 2.0;
                     }
                  ...
                  case 27:
                     ...
                     if (var4 < 0.5) {
                        ...
                        var10000 = -(Math.pow(2.0, var4 * 20.0 - 10.0) * var8) / 2.0;
                     } else {
                        var10000 = Math.pow(2.0, -20.0 * var4 + 10.0) * var8 / 2.0 + 1.0;
                     }
