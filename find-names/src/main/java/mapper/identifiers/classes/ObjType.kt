...
class ObjType : IdentityMapper.Class() {
    ...
    class op : OrderMapper.InConstructor.Field(ObjType::class, 0) {
        override val predicate = predicateOf<InstructionMapper> { it.isField && it.fieldType == Array<String>::class.type }
    }
    ...
    class members : OrderMapper.InConstructor.Field(ObjType::class, 0, 2) {
        override val predicate = predicateOf<InstructionMapper> { it.isField && it.fieldType == BOOLEAN_TYPE }
    }
...
//    }
    ...
    class zoom2d : OrderMapper.InConstructor.Field(ObjType::class, 0) {
        override val predicate = predicateOf<InstructionMapper> { it.isField && it.fieldType == INT_TYPE }
    }
